...
<#if pojo.needsMinimalConstructor()>	<#-- /** minimal constructor */ -->
    public Abstract${declarationName}(${c2j.asParameterList(pojo.getPropertyClosureForMinimalConstructor(), jdk5, pojo)}) {
...
<#-- /** full constructor */ -->
    public Abstract${declarationName}(${c2j.asParameterList(pojo.getPropertyClosureForFullConstructor(), jdk5, pojo)}) {
