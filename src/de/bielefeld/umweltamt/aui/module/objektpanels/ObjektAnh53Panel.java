...
/**
 * Das "Fotografische Prozesse"-Tab des ObjektBearbeiten-Moduls 
 * @author Gerd Genuit
 */
public class ObjektAnh53Panel extends JPanel {
	private String name;
	...
	public ObjektAnh53Panel(ObjektBearbeiten hauptModul) {
	...
	public void fetchFormData() throws RuntimeException {
		...
		AUIKataster.debugOutput("Objekt aus DB geholt: " + fachdaten, "ObjektAnh53Panel.fetchFormData");
	...
	private boolean saveAnh53Daten() {
		...
		if (success) {
			...
			"ObjektAnh53Panel.saveAnh53Daten");
		} else {
	...
	public void completeObjekt() {
		if (hauptModul.isNew() || fachdaten == null) {
			...
			AUIKataster.debugOutput("Neues Objekt "+fachdaten+" gespeichert.", "ObjektBearbeiten.completeObjekt");
		}
	}
