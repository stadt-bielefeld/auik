/*
 * Datei:
 * $Id: FettAnalysenPanel.java,v 1.1 2010-01-26 09:18:17 u633d Exp $
 * 
...
/**
 * Eine Tabelle zum Anzeigen und Erfassen von Anhang 49 Analysen angepasst für Fettabscheider
 * @author Gerd Genuit
 */
public class FettAnalysenPanel extends JPanel{
	/**
	 * Ein TableModel für eine Tabelle mit Analysen.
	 * @author Gerhard Genuit 
	 */
	
	private class FettAnalysenModel extends EditableListTableModel {
		private Anh49Fachdaten fachdaten;
		
		/**
		 * Erzeugt ein neues Analysen-TableModel.
		 * Dieses hat die Spalten "Datum", "Institut", "CSB", "Zink", "BSB5", PE, Kupfer, AOX und "Bemerkung".
		 */                            
		public FettAnalysenModel() {			
			super(new String[]{"Datum", "Institut", "CSB", "BSB5",  "PE", "Kupfer", "Zink",  "AOX", "Bemerkung",  }, false, true);
		...
		public Object getColumnValue(Object objectAtRow, int columnIndex) {
			...
			case 4:
				tmp = analysen.getPeWert();
				break;
			
			case 5:
				tmp = analysen.getKupferWert();
				break;
		...
		public void editObject(Object objectAtRow, int columnIndex, Object newValue) {
			...
			case 3:
				...
				break;
			case 4:
				String tmpPe = (String)newValue;
				// Auf 50 Zeichen kürzen, da die Datenbank-Spalte nur 50 Zeichen breit ist
				if (tmpPe.length() > 50) {
					tmpPe = tmpPe.substring(0,50);
				}
				analyse.setPeWert(tmpPe);
				break;
			case 5:
				String tmpCu = (String)newValue;
				// Auf 50 Zeichen kürzen, da die Datenbank-Spalte nur 50 Zeichen breit ist
				if (tmpCu.length() > 50) {
					tmpCu = tmpCu.substring(0,50);
				}
				analyse.setKupferWert(tmpCu);
				break;
			case 6:
				...
				break;
			case 7:
				String tmpAox = (String)newValue;
				// Auf 50 Zeichen kürzen, da die Datenbank-Spalte nur 50 Zeichen breit ist
				if (tmpAox.length() > 50) {
					tmpAox = tmpAox.substring(0,50);
				}
				analyse.setAoxWert(tmpAox);
				break;
			case 8:
	...
	private Anh49Fachdaten fachdaten;
	private FettAnalysenModel analysenModel;
	
	private JTable analysenTabelle;
	private JButton speichernButton;
	
	public FettAnalysenPanel(ObjektBearbeiten hauptModul) {
		name = "Analysen";
		this.hauptModul = hauptModul;
		
		this.analysenModel = new FettAnalysenModel();
