...
/**
 * Das "Genehmigung"-Tab des ObjektBearbeiten-Moduls
 * 
 * @author Gerd Genuit
 */
public class ObjektGenehmigungPanel extends JPanel {
	private String name;
	...
	public ObjektGenehmigungPanel(ObjektBearbeiten hauptModul) {
		name = "Genehmigung";
	...
	public void fetchFormData() throws RuntimeException {
		...
		AUIKataster.debugOutput("Genehmigung Objekt aus DB geholt: ID"
				+ fachdaten, "ObjektGenehmigungPanel.fetchFormData");
	}
	...
	private boolean saveGenehmigungDaten() {
		...
		if (success) {
			...
			AUIKataster.debugOutput("Uebergabestelle Objekt " + fachdaten
					...
					"ObjektGenehmigungPanel.saveGenehmigungDaten");
		}
		return success;
	}
	...
	public void completeObjekt() {
		if (hauptModul.isNew() || fachdaten == null) {
			...
			AUIKataster.debugOutput("Neues Genehmigung Objekt " + fachdaten
					+ " gespeichert.", "ObjektBearbeiten.completeObjekt");
		}
	}
