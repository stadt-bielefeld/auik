...
public class SonderbauwerkPanel extends JPanel {
    ...
    public SonderbauwerkPanel(BasisObjektBearbeiten hauptModul) {
        ...
        */
        ...
        PanelBuilder stillgelegt = new PanelBuilder(PanelBuilder.NORTHEAST, true, false, 1, 0, 1, 1,
                0, 0, 5, 0);
        stillgelegt.addComponent(getStillgelegtCheck(), false, true);
        stillgelegt.addComponent(getStillegdatDatum(), "am:");

        PanelBuilder stammdaten = new PanelBuilder(PanelBuilder.NORTHWEST, true, false, 0, 0, 1, 1,
                5, 0, 5, 5);
        stammdaten.setWrapLabelComponents(false);
        stammdaten.setPreferedSize(650, 500);
        stammdaten.addComponent(getBezeichnungFeld(), "Bezeichnung:", true);
        stammdaten.addComponent(getKurzbezeichnungFeld(), "Kurzbezeichnung:", true);
        stammdaten.addComponent(getVerfahrenBox(), "Entwässerungsverfahren:", true);
        stammdaten.addComponent(getTypBox(), "Typ:", true);
        stammdaten.addComponent(getInbetriebnahmeFeld(), "Inbetriebnahme:", true);
        stammdaten.addComponent(getWiederinebetriebdatDatum(), "Wiederinbetriebnahme:", true);
        stammdaten.setWeightX(1);
        stammdaten.addComponent(stillgelegt.getPanel(), "stillgelegt:", true);
        stammdaten.setWeightX(0);
        stammdaten.addComponent(getE32Feld(), "Ostwert:", true);
        stammdaten.addComponent(getN32Feld(), "Nordwert:", true);
        stammdaten.addComponent(getKlaeranlageBox(), "Kläranlage:", true);
        ...
        builder.addComponent(PanelBuilder.buildRightAlignedButtonToolbar(getSelectObjektButton(), getSaveSonderbauwerkButton()), true);
