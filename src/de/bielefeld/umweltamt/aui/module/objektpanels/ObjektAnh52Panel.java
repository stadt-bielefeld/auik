 ...
 * @author u633d
 */
public class ObjektAnh52Panel extends JPanel{
	private String name;
	...
	public void completeObjekt() {
		if (hauptModul.isNew() || fachdaten == null) {
			...
			AUIKataster.debugOutput("Neues Anh 52 Objekt "+fachdaten+" gespeichert.", "ObjektBearbeiten.completeObjekt");
		}
	}
	...
	private boolean saveAnh52Daten() {
		...
		if (success) {
			...
			"ObjektAnh52Panel.saveFachdaten");
		} else {
	...
	public void fetchFormData() throws RuntimeException {
		...
		AUIKataster.debugOutput("Anhang 52 Objekt aus DB geholt: ID" + fachdaten, "ObjektAnh52Panel.fetchFormData");
	}
