...
public class AfsNwPanel extends ObjectPanel {
    ...
    public void fetchFormData() throws RuntimeException {
    	...
    	if (this.hauptModul.getObjekt().getEntwaesserungsgrundstuecks().iterator().hasNext()) {
    		...
    		this.afsModel.setList(
        			DatabaseQuery.getAfsNwList(grundstueck)
        			);
    	}
    	if (this.hauptModul.getObjekt().getAnfallstelles().iterator().hasNext()) {
    		...
    		this.afsModel.setList(
        			DatabaseQuery.getAfsNwList(anfallstelle)
        			);
    	}
        ...
        if (this.afsNwTabelle == null) {
                ...
                .addMouseListener(new java.awt.event.MouseAdapter() {
                    ...
                    public void mouseClicked(java.awt.event.MouseEvent e) {
                        if ((e.getClickCount() == 2) && (e.getButton() == 1)) {
                            ...
                            int row = AfsNwPanel.this.afsNwTabelle
                                .rowAtPoint(origin);

                            AfsNiederschlagswasser afs = AfsNwPanel.this.afsModel
                                .getRow(row);
                        }
                    }
                });
            ...
            Action editAction = new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    // ausgewählt ist
                    if (row != -1) {
                    	AfsNiederschlagswasser afsNw = AfsNwPanel.this.afsModel
                            .getRow(row);
                    }
                }
            };
                    ...
                    if (row != -1
                        ...
                        if (GUIManager
                            ...
                            .showQuestion(
                                ...
                                "Löschen bestätigen")) {
                        	AfsNwPanel.this.afsModel
                                .removeRow(row);
                            log.debug("Probe " + afs.getLfdNr()
                                + " wurde gelöscht!");
                        }
                    }
                }
