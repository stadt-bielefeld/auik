...
/**
 * Das "Uebergabestelle"-Tab des ObjektBearbeiten-Moduls
 * 
 * @author Gerd Genuit
 */
public class ObjektUebergabePanel extends JPanel {
	private String name;
	...
	public void fetchFormData() throws RuntimeException {
		...
		AUIKataster.debugOutput("Uebergabestelle Objekt aus DB geholt: ID"
				+ fachdaten, "ObjektUebergabePanel.fetchFormData");
	}
	...
	private boolean saveUebergabestelleDaten() {
		...
		if (success) {
			AUIKataster.debugOutput("Uebergabestelle Objekt " + fachdaten.getObjektid()
					+ " gespeichert.", "ObjektAnh40Panel.saveAnh40Daten");
		} else {
