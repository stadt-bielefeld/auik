...
public class EntwaesserungsgrundstueckPanel extends JPanel {
    ...
    public EntwaesserungsgrundstueckPanel(BasisObjektBearbeiten hauptModul) {
        ...
        PanelBuilder elka = new PanelBuilder(PanelBuilder.NORTHWEST, true, false, 0, 0, 1, 1,
                0, 0, 5, 5);
        elka.addComponent(getErstellDatDatum(), "Erstellung:");
        elka.setWeightX(1);
        elka.addComponent(getBezeichnungFeld(), "Bezeichnung:");
        elka.setWrapLabelComponents(false);
        elka.setPreferedSize(650, 500);
        ...
        builder.addComponent(PanelBuilder.buildRightAlignedButtonToolbar(getSelectObjektButton(), getSaveEntwaesserungsgrundstueckButton()), true);
