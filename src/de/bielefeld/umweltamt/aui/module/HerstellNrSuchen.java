/*
 * Datei:
 * $Id: HerstellNrSuchen.java,v 1.0 2009/09/28 13:36:20 u633z 
 * 
 ...
 */
public class HerstellNrSuchen extends AbstractQueryModul {
	...
	public void SuchStart()
	{
		...
		AUIKataster.debugOutput(
				"(HerstellNrSuchen):" + " Suche nach Herstellnummer " + herstellnr
		...
		AUIKataster.debugOutput(
				"(HerstellNrSuchen): " + getTableModel().getRowCount() + " Objekt(e) mit Herstellnummer "+ herstellnr + " gefunden"
