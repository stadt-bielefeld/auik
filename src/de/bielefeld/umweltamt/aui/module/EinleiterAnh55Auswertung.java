...
/*
 * Datei:
 * $Id: EinleiterAnh55Auswertung.java,v 1.1.2.1 2010-11-23 10:25:53 u633d Exp $
 *
 * Erstellt am 03.05.2006 von Gerd Genuit
 *
 * CVS-Log:
 * $Log: not supported by cvs2svn $
 * Revision 1.3  2010/01/12 09:03:30  u633d
 ...
 * @author Gerd Genuit
 */
public class EinleiterAnh55Auswertung extends AbstractQueryModul {
                ...
                public void actionPerformed(ActionEvent e) {
                    SwingWorkerVariant worker = new SwingWorkerVariant(getResultTable()) {
                        ...
                        protected void doNonUILogic() {
                            ((Anh55Model)getTableModel()).setList(
                                DatabaseQuery.getAnhang55());
                        }
