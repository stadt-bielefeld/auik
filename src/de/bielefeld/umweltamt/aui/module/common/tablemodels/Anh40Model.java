 ...
 * @author Gerd Genuit
 */
public class Anh40Model extends ListTableModel<Anh40Fachdaten> {
     ...
     */
    @Override
    public Object getColumnValue(Anh40Fachdaten fd, int columnIndex) {
        Object tmp;
        ...
        case 2:
			tmp = "";
			if (fd.getAnfallstelle().getObjekt().getSachbearbeiter() != null) {
				tmp = fd.getAnfallstelle().getObjekt().getSachbearbeiter().getName();
			}
			break;
        case 3:
			tmp = "";
