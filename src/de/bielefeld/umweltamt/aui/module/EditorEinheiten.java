 ...
 * @author Gerd Genuit
 */
public class EditorEinheiten extends AbstractModul {
	/** Logging */
    ...
    public JPanel getPanel() {
        if (panel == null) {
            ...
            submitButton = new JButton("Alle Einheiten anzeigen");
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (row != -1 && getResultTable().getEditingRow() == -1) {
                        ...
                        if (GUIManager.getInstance().showQuestion(
                            "Soll die Einheit " + einheit.getBezeichnung()
                                + " wirklich gelöscht werden?\n",
                            "Löschen bestätigen")) {
                            if (EditorEinheiten.this.tmodel
                                .removeRow(row)) {
                            	EditorEinheiten.this.frame.changeStatus(
                                    "Einheit gelöscht.",
                                    HauptFrame.SUCCESS_COLOR);
                                log.debug("Objektart " + einheit.getBezeichnung()
                                    + " wurde gelöscht!");
                            } else {
                            	EditorEinheiten.this.frame.changeStatus(
