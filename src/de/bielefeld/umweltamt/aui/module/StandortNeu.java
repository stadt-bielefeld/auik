 ...
 * @author David Klotz
 */
public class StandortNeu extends AbstractModul {
	...
	private void doSave() {
		...
		if (handzeichenNeuFeld.getText().equals("")) {
			...
			if (bsta != null) {
				...
				AUIKataster.debugOutput("Konnte nicht speichern", "StandortNeu.doSave");
			}
		}
	}
	...
	private final class StandortNeuListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == speichernButton) {
				AUIKataster.debugOutput("Speichern gedrückt!", StandortNeu.this.getIdentifier());
				doSave();
