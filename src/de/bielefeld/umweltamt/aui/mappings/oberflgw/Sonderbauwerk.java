...
/**
 * A class that represents a row in the Sonderbauwerk database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class Sonderbauwerk  implements java.io.Serializable {
    ...
    public boolean isRohrspeicherTog() {
    ...
    public boolean isAReiEinrichTog() {
    ...
    public boolean isFuellstandTog() {
    ...
    public boolean isEntlastungswasserTog() {
    ...
    public boolean isEntlastungsdauerTog() {
    ...
    public boolean isEntlastungshaeufigTog() {
    ...
    public boolean isNiederschlagTog() {
    ...
    public boolean isHwEinrichtungTog() {
    ...
    public boolean isHwRueckstauTog() {
    ...
    public boolean isHwSchieberTog() {
    ...
    public boolean isHwPumpwerkTog() {
    ...
    public boolean isBemesWeitergTog() {
    ...
    public boolean isDrossUeberTog() {
    ...
    public Set<Referenz> getReferenzsForQSbNr() {
        return this.referenzsForQSbNr;
    }

    public void setReferenzsForQSbNr(Set<Referenz> referenzsForQSbNr) {
        this.referenzsForQSbNr = referenzsForQSbNr;
    }

    public Set<Referenz> getReferenzsForZSbNr() {
        return this.referenzsForZSbNr;
    }
    ...
    public String toDebugString() {
        ...
        buffer.append("inNrwTog").append("='").append(isInNrwTog()).append("' ");			
        buffer.append("industrTog").append("='").append(isIndustrTog()).append("' ");			
        ...
        buffer.append("rohrspeicherTog").append("='").append(isRohrspeicherTog()).append("' ");			
        ...
        buffer.append("AReiEinrichTog").append("='").append(isAReiEinrichTog()).append("' ");			
        buffer.append("messartTog").append("='").append(isMessartTog()).append("' ");			
        buffer.append("drosselTog").append("='").append(isDrosselTog()).append("' ");			
        buffer.append("fuellstandTog").append("='").append(isFuellstandTog()).append("' ");			
        buffer.append("entlastungswasserTog").append("='").append(isEntlastungswasserTog()).append("' ");			
        buffer.append("entlastungsdauerTog").append("='").append(isEntlastungsdauerTog()).append("' ");			
        buffer.append("entlastungshaeufigTog").append("='").append(isEntlastungshaeufigTog()).append("' ");			
        buffer.append("fernMessTog").append("='").append(isFernMessTog()).append("' ");			
        buffer.append("niederschlagTog").append("='").append(isNiederschlagTog()).append("' ");			
        buffer.append("fernStoerTog").append("='").append(isFernStoerTog()).append("' ");			
        buffer.append("hwfreiTog").append("='").append(isHwfreiTog()).append("' ");			
        buffer.append("einstauHaeufig").append("='").append(getEinstauHaeufig()).append("' ");			
        buffer.append("hwEinrichtungTog").append("='").append(isHwEinrichtungTog()).append("' ");			
        buffer.append("hwRueckstauTog").append("='").append(isHwRueckstauTog()).append("' ");			
        buffer.append("hwSchieberTog").append("='").append(isHwSchieberTog()).append("' ");			
        buffer.append("hwPumpwerkTog").append("='").append(isHwPumpwerkTog()).append("' ");			
        buffer.append("hwWeitereTog").append("='").append(isHwWeitereTog()).append("' ");			
        buffer.append("hwSonstText").append("='").append(getHwSonstText()).append("' ");			
        buffer.append("bemesWeitergTog").append("='").append(isBemesWeitergTog()).append("' ");			
        ...
        buffer.append("drossUeberTog").append("='").append(isDrossUeberTog()).append("' ");			
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Sonderbauwerk)) return false;
        return (this.getNr().equals(
            ((Sonderbauwerk) other).getNr()));
    }
     ...
     * @return <code>Sonderbauwerk</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static Sonderbauwerk merge(Sonderbauwerk detachedInstance) {
        log.debug("Merging Sonderbauwerk instance " + detachedInstance);
        return (Sonderbauwerk) new DatabaseAccess().merge(detachedInstance);
    }
    ...
    public boolean merge() {
        Sonderbauwerk saved = Sonderbauwerk.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this Sonderbauwerk with its new values.<br>
     * This is meant to be used after merging!
     * @param copy Sonderbauwerk
     */
    private void copy(Sonderbauwerk copy) {
        this.nr = copy.getNr();            
        ...
        this.kurzbeschreibung = copy.getKurzbeschreibung();            
        this.entwEinzugsgebOpt = copy.getEntwEinzugsgebOpt();            
        this.typOpt = copy.getTypOpt();            
        this.inbetriebnahme = copy.getInbetriebnahme();            
        this.stillgelegtAm = copy.getStillgelegtAm();            
        this.wiederinbetrDat = copy.getWiederinbetrDat();            
        this.bemerkung = copy.getBemerkung();            
        this.e32 = copy.getE32();            
        this.n32 = copy.getN32();            
        this.inNrwTog = copy.isInNrwTog();            
        this.industrTog = copy.isIndustrTog();            
        this.nameAusserhalbNrw = copy.getNameAusserhalbNrw();            
        this.KEntwGebiet = copy.getKEntwGebiet();            
        this.befFlaecheEgebiet = copy.getBefFlaecheEgebiet();            
        this.abflussbeiwert = copy.getAbflussbeiwert();            
        this.befGrad = copy.getBefGrad();            
        this.undurchFlaeche = copy.getUndurchFlaeche();            
        this.beckentypOpt = copy.getBeckentypOpt();            
        this.rohrspeicherTog = copy.isRohrspeicherTog();            
        this.bauweiseOpt = copy.getBauweiseOpt();            
        this.drosselOpt = copy.getDrosselOpt();            
        this.soDrossel = copy.getSoDrossel();            
        this.beckensteuerungOpt = copy.getBeckensteuerungOpt();            
        this.AReiEinrichTog = copy.isAReiEinrichTog();            
        this.messartTog = copy.isMessartTog();            
        this.drosselTog = copy.isDrosselTog();            
        this.fuellstandTog = copy.isFuellstandTog();            
        this.entlastungswasserTog = copy.isEntlastungswasserTog();            
        this.entlastungsdauerTog = copy.isEntlastungsdauerTog();            
        this.entlastungshaeufigTog = copy.isEntlastungshaeufigTog();            
        this.fernMessTog = copy.isFernMessTog();            
        this.niederschlagTog = copy.isNiederschlagTog();            
        this.fernStoerTog = copy.isFernStoerTog();            
        this.hwfreiTog = copy.isHwfreiTog();            
        this.einstauHaeufig = copy.getEinstauHaeufig();            
        this.hwEinrichtungTog = copy.isHwEinrichtungTog();            
        this.hwRueckstauTog = copy.isHwRueckstauTog();            
        this.hwSchieberTog = copy.isHwSchieberTog();            
        this.hwPumpwerkTog = copy.isHwPumpwerkTog();            
        this.hwWeitereTog = copy.isHwWeitereTog();            
        this.hwSonstText = copy.getHwSonstText();            
        this.bemesWeitergTog = copy.isBemesWeitergTog();            
        this.bemessungText = copy.getBemessungText();            
        this.anordnungOpt = copy.getAnordnungOpt();            
        this.beckenartOpt = copy.getBeckenartOpt();            
        this.beckentiefe = copy.getBeckentiefe();            
        this.behFlaeche1u2 = copy.getBehFlaeche1u2();            
        this.behFlaeche2u3 = copy.getBehFlaeche2u3();            
        this.betriebsartOpt = copy.getBetriebsartOpt();            
        this.csb = copy.getCsb();            
        this.drosselabfluss = copy.getDrosselabfluss();            
        this.drossAbflussOpt = copy.getDrossAbflussOpt();            
        this.drossUeberTog = copy.isDrossUeberTog();            
        this.entlastungsartOpt = copy.getEntlastungsartOpt();            
        this.entleerungszeit = copy.getEntleerungszeit();            
        this.flaechenbeschickung = copy.getFlaechenbeschickung();            
        this.fliesszeit = copy.getFliesszeit();            
        this.fremdAbfluss = copy.getFremdAbfluss();            
        this.funktionOpt = copy.getFunktionOpt();            
        this.kanalVol = copy.getKanalVol();            
        this.qrkrit = copy.getQrkrit();            
        this.kritischMisch = copy.getKritischMisch();            
        this.maxHSchmutzabfluss = copy.getMaxHSchmutzabfluss();            
        this.maxHTrocken = copy.getMaxHTrocken();            
        this.minDrAbfluss = copy.getMinDrAbfluss();            
        this.mischUeberlauf = copy.getMischUeberlauf();            
        this.NMindestV = copy.getNMindestV();            
        this.NSpezVol = copy.getNSpezVol();            
        this.neigung = copy.getNeigung();            
        this.rdrosseldurchfluss = copy.getRdrosseldurchfluss();            
        this.regenabflDross = copy.getRegenabflDross();            
        this.regenabflEntl = copy.getRegenabflEntl();            
        this.regenabfluss = copy.getRegenabfluss();            
        this.regenabflussDr = copy.getRegenabflussDr();            
        this.regenspende = copy.getRegenspende();            
        this.rfilterflaeche = copy.getRfilterflaeche();            
        this.rfiltergeschwin = copy.getRfiltergeschwin();            
        this.rfiltersubstratH = copy.getRfiltersubstratH();            
        this.rhydWirkungsgrad = copy.getRhydWirkungsgrad();            
        this.rjahrUeh = copy.getRjahrUeh();            
        this.rkrit = copy.getRkrit();            
        this.rmFilterbelastung = copy.getRmFilterbelastung();            
        this.rspezFiltervol = copy.getRspezFiltervol();            
        this.rstauvolumen = copy.getRstauvolumen();            
        this.rvolSlamelle = copy.getRvolSlamelle();            
        this.rwKritAbfluss = copy.getRwKritAbfluss();            
        this.rwKritMisch = copy.getRwKritMisch();            
        this.rwMindestMisch = copy.getRwMindestMisch();            
        this.schmutzAbfluss = copy.getSchmutzAbfluss();            
        this.skuAnstroem = copy.getSkuAnstroem();            
        this.skuMindestSvol = copy.getSkuMindestSvol();            
        this.skuSpezVol = copy.getSkuSpezVol();            
        this.spezBeckenvol = copy.getSpezBeckenvol();            
        this.spezSpeicher = copy.getSpezSpeicher();            
        this.trockenWAbfluss = copy.getTrockenWAbfluss();            
        this.speichervolumen = copy.getSpeichervolumen();            
        this.WOberflaeche = copy.getWOberflaeche();            
     ...
     *         <code>false</code> otherwise
     */
    public static boolean delete(Sonderbauwerk detachedInstance) {
        log.debug("Deleting Sonderbauwerk instance " + detachedInstance);
    ...
    public boolean delete() {
        return Sonderbauwerk.delete(this);
    }

    /**
     * Find an <code>Sonderbauwerk</code> instance by its primary key
     * @param id the primary key value
     * @return <code>Sonderbauwerk</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    ...
    /**
     * Get a list of all <code>Sonderbauwerk</code>
     * @return <code>List&lt;Sonderbauwerk&gt;</code>
     *         all <code>Sonderbauwerk</code>
     */
    public static List<Sonderbauwerk> getAll() {
