...
/**
 * A class that represents a row in the Einheiten database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class Einheiten  implements java.io.Serializable {
    ...
    /** Full constructor */
    public Einheiten(
        Integer id, String bezeichnung, boolean enabled, boolean deleted, Integer deaEinheitenMasseinheitenNr, Set<Analyseposition> analysepositions, Set<MetaParameter> metaParameters) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Einheiten)) return false;
        return (this.getId().equals(
            ((Einheiten) other).getId()));
    }
     ...
     * @return <code>Einheiten</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static Einheiten merge(Einheiten detachedInstance) {
        log.debug("Merging Einheiten instance " + detachedInstance);
        return (Einheiten) new DatabaseAccess().merge(detachedInstance);
    }
    ...
    public boolean merge() {
        Einheiten saved = Einheiten.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this Einheiten with its new values.<br>
     ...
     *         <code>false</code> otherwise
     */
    public static boolean delete(Einheiten detachedInstance) {
        log.debug("Deleting Einheiten instance " + detachedInstance);
    ...
    public boolean delete() {
        return Einheiten.delete(this);
    }

    /**
     * Find an <code>Einheiten</code> instance by its primary key
     * @param id the primary key value
     * @return <code>Einheiten</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static Einheiten findById(java.lang.Integer id) {
        log.debug("Getting Einheiten instance with id: " + id);
        return (Einheiten)
            new DatabaseAccess().get(Einheiten.class, id);
    }

    /**
     * Get a list of all <code>Einheiten</code>
     * @return <code>List&lt;Einheiten&gt;</code>
     *         all <code>Einheiten</code>
     */
    public static List<Einheiten> getAll() {
