...
/**
 * A class that represents a row in the ViewSielhautqbProbenahmenRoutineId database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class ViewSielhautqbProbenahmenRoutineId  implements java.io.Serializable {

    /** Generated serialVersionUID for Serializable interface */
    private static final long serialVersionUID =
        DatabaseSerialVersionUID.forViewSielhautqbProbenahmenRoutineId;
    ...
    /** Default constructor */
    public ViewSielhautqbProbenahmenRoutineId() {
    ...
    /** Full constructor */
    public ViewSielhautqbProbenahmenRoutineId(
        Long rowNumber, Integer id, String kennummer, String bezeichnung, String lage, Date datumDerEntnahme, Integer objektid) {
    ...
    public String toDebugString() {
        ...
        buffer.append("rowNumber").append("='").append(getRowNumber()).append("' ");			
