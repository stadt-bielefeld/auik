...
public class AtlKlaeranlagen  implements java.io.Serializable {
    ...
    public boolean merge() {
        AtlKlaeranlagen saved = AtlKlaeranlagen.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this AtlKlaeranlagen with its new values.<br>
     ...
     *         <code>null</code> otherwise
     */
    public static AtlKlaeranlagen findById(java.lang.Integer id) {
    ...
    public static List<AtlKlaeranlagen> getAll() {
        return DatabaseQuery.getAll(new AtlKlaeranlagen());
    }
