 ...
 * behavior of this class by editing the class, {@link DeaAdresse}.
 */
public abstract class AbstractDeaAdresse implements java.io.Serializable {

    private static final long serialVersionUID = -46651306469877999L;
    ...
    public AbstractDeaAdresse(Integer adresseNr) {
        this.adresseNr = adresseNr;
    }

    public AbstractDeaAdresse(Integer adresseNr, Integer adresseVer,
        ...
        String name1, String name2, String strasse, String hausnr, String plz,
        String ort, String staatskennung, String telefon, String telefonMobil,
