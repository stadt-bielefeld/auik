 ...
 * behavior of this class by editing the class, {@link InkaMessstelle}.
 */
public abstract class AbstractInkaMessstelle implements java.io.Serializable {

    private static final long serialVersionUID = 3175202166440491252L;
    ...
    public AbstractInkaMessstelle(Integer messstelleLfdNr) {
    ...
    public AbstractInkaMessstelle(Integer messstelleLfdNr,
        ...
        Integer messstelleVer, Calendar gueltigVon, Calendar gueltigBis,
        Calendar aenderungsDatum, Calendar erfassungsDatum,
        Integer historienNr, Boolean istAktuellJn, Integer genehmigungNr,
        Integer genehmigungVer, Integer messstelleTyp, String beschrMesspunkt,
        Boolean relevantSumFrachtJn) {
        this.messstelleLfdNr = messstelleLfdNr;
