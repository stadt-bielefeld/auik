 ...
 * behavior of this class by editing the class, {@link InkaBetrieb}.
 */
public abstract class AbstractInkaBetrieb implements java.io.Serializable {

    private static final long serialVersionUID = -6786852385690755052L;
    ...
    public AbstractInkaBetrieb(Integer betriebNr) {
        this.betriebNr = betriebNr;
    }

    public AbstractInkaBetrieb(Integer betriebNr, Integer betriebVer,
        Calendar gueltigVon, Calendar gueltigBis, Calendar aenderungsDatum,
        Calendar erfassungsDatum, Integer historienNr, Boolean istAktuellJn,
        Integer adresseStandNr, Integer adresseStandVer,
        Integer adresseEinleitNr, Integer adresseEinleitVer,
        Integer adresseAnsprNr, Integer adresseAnsprVer,
