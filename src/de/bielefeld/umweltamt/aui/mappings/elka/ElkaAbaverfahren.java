 ...
 */
public class ElkaAbaverfahren  implements java.io.Serializable {
    ...
    /** Default constructor */
    public ElkaAbaverfahren() {
        // This place is intentionally left blank.
    }

    /** Minimal constructor */
	public ElkaAbaverfahren(Integer nr) {
		this.nr = nr;
	}
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ElkaAbaverfahren)) return false;
        return (this.getNr().equals(
            ((ElkaAbaverfahren) other).getNr()));
    }
     ...
     */
    public static ElkaAbaverfahren merge(ElkaAbaverfahren detachedInstance) {
        log.debug("Merging IndeinlGenehmigung instance " + detachedInstance);
        return (ElkaAbaverfahren) new DatabaseAccess().merge(detachedInstance);
    }
    ...
    public boolean merge() {
        ElkaAbaverfahren saved = ElkaAbaverfahren.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
     ...
     * @param copy ElkaAba
     */
    private void copy(ElkaAbaverfahren copy) {           
     ...
     *         <code>false</code> otherwise
     */
    public static boolean delete(ElkaAbaverfahren detachedInstance) {
    ...
    public boolean delete() {
        return ElkaAbaverfahren.delete(this);
    }

    /**
     * Find an <code>ElkaAbaverfahren</code> instance by its primary key
     * @param id the primary key value
     * @return <code>ElkaAbaverfahren</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static ElkaAbaverfahren findById(java.lang.Integer id) {
        log.debug("Getting BasisWasserrecht instance with id: " + id);
        return (ElkaAbaverfahren)
            new DatabaseAccess().get(ElkaAbaverfahren.class, id);
    }

    /**
     * Get a list of all <code>ElkaAbaverfahren</code>
     * @return <code>List&lt;ElkaAbaverfahren;</code>
     *         all <code>ElkaAbaverfahren</code>
     */
    public static List<ElkaAbaverfahren> getAll() {
        return DatabaseQuery.getAll(new ElkaAbaverfahren());
    }
