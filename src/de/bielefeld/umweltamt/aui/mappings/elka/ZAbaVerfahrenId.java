...
/**
 * A class that represents a row in the ZAbaVerfahrenId database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class ZAbaVerfahrenId  implements java.io.Serializable {
    ...
    /** Full constructor */
    public ZAbaVerfahrenId(
        long anlageNr, long abwasbehverfNr) {
