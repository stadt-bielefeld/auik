...
/**
 * A class that represents a row in the ElkaWasserrecht database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class ElkaWasserrecht  implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ElkaWasserrecht)) return false;
        return (this.getObjektid().equals(
            ((ElkaWasserrecht) other).getObjektid()));
    }
     ...
     * @return <code>ElkaWasserrecht</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static ElkaWasserrecht merge(ElkaWasserrecht detachedInstance) {
        log.debug("Merging IndeinlGenehmigung instance " + detachedInstance);
        return (ElkaWasserrecht) new DatabaseAccess().merge(detachedInstance);
    }
    ...
    public boolean merge() {
        ElkaWasserrecht saved = ElkaWasserrecht.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this ElkaWasserrecht with its new values.<br>
     * This is meant to be used after merging!
     * @param copy ElkaWasserrecht
     */
    private void copy(ElkaWasserrecht copy) {
     ...
     *         <code>false</code> otherwise
     */
    public static boolean delete(ElkaWasserrecht detachedInstance) {
    ...
    public boolean delete() {
        return ElkaWasserrecht.delete(this);
    }

    /**
     * Find an <code>ElkaWasserrecht</code> instance by its primary key
     * @param id the primary key value
     * @return <code>ElkaWasserrecht</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static ElkaWasserrecht findById(java.lang.Integer id) {
        log.debug("Getting BasisWasserrecht instance with id: " + id);
        return (ElkaWasserrecht)
            new DatabaseAccess().get(ElkaWasserrecht.class, id);
    }

    /**
     * Get a list of all <code>ElkaWasserrecht</code>
     * @return <code>List&lt;ElkaWasserrecht&gt;</code>
     *         all <code>ElkaWasserrecht</code>
     */
    public static List<ElkaWasserrecht> getAll() {
        return DatabaseQuery.getAll(new ElkaWasserrecht());
    }

    /* Custom code goes below here! */
    public static ElkaWasserrecht findByObjektId(java.lang.Integer id) {
        ...
        Set<ElkaWasserrecht> list = objekt.getElkaWasserrechts();
