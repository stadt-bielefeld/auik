...
/**
 * A class that represents a row in the VAWS_ANLAGENARTEN table. You can
 * customize the behavior of this class by editing the class, {@link
 * VawsAnlagenarten()}.
 */
public abstract class AbstractVawsAnlagenarten implements Serializable {
    private static final long serialVersionUID = -8899099293907437853L;
