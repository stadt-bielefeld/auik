...
/**
 * A class that represents a row in the 'VAWS_ANLAGENCHRONO' table. This class
 * may be customized as it is never re-generated after being created.
 */
public class VawsAnlagenchrono extends AbstractVawsAnlagenchrono implements
    Serializable {
    private static final long serialVersionUID = -2767617914450702894L;
    /** Logging */
    ...
    public static List<?> getAnlagenChrono(VawsFachdaten fachdaten) {
        ...
        if (fachdaten.getBehaelterId() == null) {
            ...
            log.debug(chrono.size() + " AChrono-Einträge für FD " + fachdaten
                + " gefunden!");
        }
