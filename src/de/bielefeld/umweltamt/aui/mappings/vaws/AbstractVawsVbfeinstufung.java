...
/**
 * A class that represents a row in the VAWS_VBFEINSTUFUNG table. You can
 * customize the behavior of this class by editing the class, {@link
 * VawsVbfeinstufung()}.
 */
public abstract class AbstractVawsVbfeinstufung implements Serializable {
    private static final long serialVersionUID = -6982781841774427859L;
