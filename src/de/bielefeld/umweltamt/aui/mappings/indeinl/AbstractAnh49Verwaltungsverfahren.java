 ...
 * You can customize the behavior of this class by editing the class, {@link Anh49Verwaltungsverfahren()}.
 ...
 */
public abstract class AbstractAnh49Verwaltungsverfahren
	implements Serializable
{
	 ...
	 * Setting to 0 triggers re-calculation.
	 */
     ...
     * primary key values.
     * 
     * TODO: Why the hell is this in the abstract class?
     * 
     * @param rhs
     * @return boolean
     */
    public boolean equals(Object rhs) {
        ...
        if (this.getVerwaltungsverfahrenID() != null
            ...
            if (! this.getVerwaltungsverfahrenID()
            		.equals(that.getVerwaltungsverfahrenID())) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        if (this.hashValue == 0) {
            int result = 17;
            int verwaltungsverfahrenIDValue =
            	(this.getVerwaltungsverfahrenID() == null) ?
            			0 : this.getVerwaltungsverfahrenID().hashCode();
