...
public class AnhSuevFachdaten  implements java.io.Serializable {
    ...
    /** Full constructor */
    public AnhSuevFachdaten(
        Integer id, BasisObjekt basisObjekt, Boolean groesser3ha, Integer versFlaeche, Boolean suevkanPflicht, Boolean indirektsw, Boolean indirektrw, Boolean direktsw, Boolean direktrw, Integer anzeige58, Boolean sanierungErfolgt, Boolean sanierungskonzept, Boolean keineAngaben, Date datAnzeige58, Date datAnschreiben, boolean enabled, boolean deleted) {
        this.id = id;
        this.basisObjekt = basisObjekt;
    ...
    public static AnhSuevFachdaten findByObjektId(java.lang.Integer id){
        log.debug("Getting AnhSuevFachdaten instance with objektid: " + id);
        List<AnhSuevFachdaten> all = AnhSuevFachdaten.getAll();
        for(AnhSuevFachdaten i : all){
            if(i.getBasisObjekt().getId().equals(id)){
                return (AnhSuevFachdaten) new DatabaseAccess().get(AnhSuevFachdaten.class, i.getId());
            }
        }
        return null;
    }
