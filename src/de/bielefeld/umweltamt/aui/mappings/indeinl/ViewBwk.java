...
public class ViewBwk  implements java.io.Serializable {
    ...
    private static final long serialVersionUID =
        DatabaseSerialVersionUID.forViewBwk;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ViewBwk)) return false;
    ...
    public boolean merge() {
        ViewBwk saved = ViewBwk.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this ViewBwk with its new values.<br>
     * This is meant to be used after merging!
     * @param copy ViewBwk
     */
    private void copy(ViewBwk copy) {
        this.id = copy.getId();            
    }    
     ...
     *         <code>null</code> otherwise
     */
    public static ViewBwk findById(de.bielefeld.umweltamt.aui.mappings.indeinl.ViewBwkId id) {
    ...
    public static List<ViewBwk> getAll() {
        return DatabaseQuery.getAll(new ViewBwk());
    }
