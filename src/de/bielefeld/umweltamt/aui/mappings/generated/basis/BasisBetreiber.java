...
public class BasisBetreiber  implements java.io.Serializable {
    ...
    public static List<BasisBetreiber> getAll() {
        log.debug("Getting all BasisBetreiber instances");
        String query = "FROM BasisBetreiber";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<BasisBetreiber> resultList = new ArrayList<BasisBetreiber>();
        BasisBetreiber result = null;
        for (Object object : objectList) {
            result = (BasisBetreiber) object;
