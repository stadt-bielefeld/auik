...
public class BasisStandort extends AbstractBasisStandort {
    ...
    public static boolean saveOrUpdate(BasisStandort detachedInstance) {
    ...
    public BasisStandort findById( java.lang.Integer id) {
        log.debug("getting BasisStandort instance with id: " + id);
        BasisStandort instance = (BasisStandort)
