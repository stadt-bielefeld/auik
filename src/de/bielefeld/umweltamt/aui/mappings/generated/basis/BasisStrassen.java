...
public class BasisStrassen  implements java.io.Serializable {
    ...
    /** Full constructor */
    public BasisStrassen(
        int id, String strasse, String plz, boolean enabled, boolean deleted) {
        this.id = id;
     ...
     *         <code>null</code> otherwise
     */
    public static BasisStrassen findById(int id) {
        log.debug("Getting BasisStrassen instance with id: " + id);
        return (BasisStrassen)
    ...
    public static List<BasisStrassen> getAll() {
        log.debug("Getting all BasisStrassen instances");
        String query = "FROM BasisStrassen";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<BasisStrassen> resultList = new ArrayList<BasisStrassen>();
        BasisStrassen result = null;
        for (Object object : objectList) {
            result = (BasisStrassen) object;
