...
public class BasisObjektverknuepfung extends AbstractBasisObjektverknuepfung {
    ...
    public static boolean saveOrUpdate(BasisObjektverknuepfung detachedInstance) {
    ...
    public BasisObjektverknuepfung findById( java.lang.Integer id) {
        log.debug("getting BasisObjektverknuepfung instance with id: " + id);
        BasisObjektverknuepfung instance = (BasisObjektverknuepfung)
