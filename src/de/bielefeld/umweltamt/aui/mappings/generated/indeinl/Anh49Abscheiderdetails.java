...
public class Anh49Abscheiderdetails  implements java.io.Serializable {
    ...
    private Calendar entsorgungsnachweis;
    ...
    public Calendar getEntsorgungsnachweis() {
        return this.entsorgungsnachweis;
    }

    public void setEntsorgungsnachweis(Calendar entsorgungsnachweis) {
        this.entsorgungsnachweis = entsorgungsnachweis;
    }
    ...
    public boolean merge() {
        return Anh49Abscheiderdetails.merge(this).equals(this);
    }
    ...
    public static List<Anh49Abscheiderdetails> getAll() {
        log.debug("Getting all Anh49Abscheiderdetails instances");
        String query = "FROM Anh49Abscheiderdetails";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<Anh49Abscheiderdetails> resultList = new ArrayList<Anh49Abscheiderdetails>();
        Anh49Abscheiderdetails result = null;
        for (Object object : objectList) {
            result = (Anh49Abscheiderdetails) object;
