...
public class Anh55Fachdaten  implements java.io.Serializable {
    ...
    public boolean merge() {
        return Anh55Fachdaten.merge(this).equals(this);
    }
     ...
     *         <code>null</code> otherwise
     */
    public static Anh55Fachdaten findById(int id) {
    ...
    public static List<Anh55Fachdaten> getAll() {
        log.debug("Getting all Anh55Fachdaten instances");
        String query = "FROM Anh55Fachdaten";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<Anh55Fachdaten> resultList = new ArrayList<Anh55Fachdaten>();
        Anh55Fachdaten result = null;
        for (Object object : objectList) {
            result = (Anh55Fachdaten) object;
