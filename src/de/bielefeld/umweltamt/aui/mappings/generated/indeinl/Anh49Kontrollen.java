...
public class Anh49Kontrollen extends AbstractAnh49Kontrollen {
    ...
    public static boolean saveOrUpdate(Anh49Kontrollen detachedInstance) {
    ...
    public Anh49Kontrollen findById( java.lang.Integer id) {
        log.debug("getting Anh49Kontrollen instance with id: " + id);
        Anh49Kontrollen instance = (Anh49Kontrollen)
