...
/**
 * DeaKlaeranlage generated by hbm2java
 */
public abstract class AbstractDeaKlaeranlage  implements java.io.Serializable {
    ...
    public AbstractDeaKlaeranlage(DeaKlaeranlageId id, String herkunft, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
