...
/**
 * DeaGemeinde generated by hbm2java
 */
public abstract class AbstractDeaGemeinde  implements java.io.Serializable {
    ...
    public AbstractDeaGemeinde(DeaGemeindeId id, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
    ...
    public AbstractDeaGemeinde(DeaGemeindeId id, Date inkaGueltigVon, Date inkaGueltigBis, short istAktuellTog, Date erfassungsDatum, Date aenderungsDatum, Integer stuaNr, Integer stuaVersion, String name, Integer gkkMinRechts2, Integer gkkMinHoch2, Integer gkkMaxRechts2, Integer gkkMaxHoch2, Integer gkkMinRechts3, Integer gkkMinHoch3, Integer gkkMaxRechts3, Integer gkkMaxHoch3, Integer n32Max, Integer e32Max, Integer n32Min, Integer e32Min, int zustandsNr, Date gueltigVon, Date igStichtag, Date gueltigBis, Date erstellDat, Date aktualDat, int versionsnr, Date zeitstempel) {
       this.id = id;
       this.inkaGueltigVon = inkaGueltigVon;
