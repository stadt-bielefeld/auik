 ...
 * {@link DeaWasserbehoerden}.
 */
public abstract class AbstractDeaWasserbehoerden  implements java.io.Serializable {
    ...
    public AbstractDeaWasserbehoerden() {
    }

    public AbstractDeaWasserbehoerden(
    	DeaWasserbehoerdenId id, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
    ...
    public AbstractDeaWasserbehoerden(
    	DeaWasserbehoerdenId id, Date inkaGueltigVon, Date inkaGueltigBis, short istAktuellTog, Date erfassungsDatum, Date aenderungsDatum, String name, Integer behoerdenTypOpt, int zustandsNr, Date gueltigVon, Date igStichtag, Date gueltigBis, Date erstellDat, Date aktualDat, int versionsnr, Date zeitstempel) {
        this.id = id;
        this.inkaGueltigVon = inkaGueltigVon;
