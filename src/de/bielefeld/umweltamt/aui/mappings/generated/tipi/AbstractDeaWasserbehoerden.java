...
/**
 * DeaWasserbehoerden generated by hbm2java
 */
public abstract class AbstractDeaWasserbehoerden  implements java.io.Serializable {
    ...
    public AbstractDeaWasserbehoerden(DeaWasserbehoerdenId id, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
