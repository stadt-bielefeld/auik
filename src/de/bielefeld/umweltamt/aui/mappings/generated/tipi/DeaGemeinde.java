...
/**
 * A class that represents a row in the DeaGemeinde database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class DeaGemeinde  implements java.io.Serializable {
    ...
    /** Minimal constructor */
    public DeaGemeinde(
        DeaGemeindeId id, Calendar inkaGueltigVon, short istAktuellTog, Calendar erfassungsDatum, int zustandsNr, Calendar gueltigVon, Calendar erstellDat, Calendar aktualDat, int versionsnr) {
        this.id = id;
     ...
     * @return <code>DeaGemeinde</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static DeaGemeinde merge(DeaGemeinde detachedInstance) {
        log.debug("Merging DeaGemeinde instance " + detachedInstance);
    ...
    public boolean merge() {
        return DeaGemeinde.merge(this).equals(this);
    }
    ...
    public static boolean delete(DeaGemeinde detachedInstance) {
        log.debug("Deleting DeaGemeinde instance " + detachedInstance);
    ...
    public boolean delete() {
        return DeaGemeinde.delete(this);
    }

    /**
     * Find an <code>DeaGemeinde</code> instance by its primary key
     * @param id the primary key value
     * @return <code>DeaGemeinde</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static DeaGemeinde findById(de.bielefeld.umweltamt.aui.mappings.generated.tipi.DeaGemeindeId id) {
    ...
    /**
     * Get a list of all <code>DeaGemeinde</code>
     * @return <code>List&lt;DeaGemeinde&gt;</code>
     *         all <code>DeaGemeinde</code>
     */
    public static List<DeaGemeinde> getAll() {
        log.debug("Getting all DeaGemeinde instances");
        String query = "FROM DeaGemeinde";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<DeaGemeinde> resultList = new ArrayList<DeaGemeinde>();
        DeaGemeinde result = null;
        for (Object object : objectList) {
            result = (DeaGemeinde) object;
