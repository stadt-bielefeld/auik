...
/**
 * A class that represents a row in the DeaEinheiten database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class DeaEinheiten  implements java.io.Serializable {
    ...
    /** Minimal constructor */
    public DeaEinheiten(
        DeaEinheitenId id, Calendar inkaGueltigVon, short istAktuellTog, Calendar erfassungsDatum, int zustandsNr, Calendar gueltigVon, Calendar erstellDat, Calendar aktualDat, int versionsnr) {
        this.id = id;
    ...
    /** Full constructor */
    public DeaEinheiten(
        DeaEinheitenId id, Calendar inkaGueltigVon, Calendar inkaGueltigBis, short istAktuellTog, Calendar erfassungsDatum, Calendar aenderungsDatum, String einheitenZeichen, Double skalenfaktor, Integer bezugsmasseinheitNr, String beschreibung, int zustandsNr, Calendar gueltigVon, Calendar igStichtag, Calendar gueltigBis, Calendar erstellDat, Calendar aktualDat, int versionsnr, Calendar zeitstempel) {
        this.id = id;
        this.inkaGueltigVon = inkaGueltigVon;
     ...
     * @return <code>DeaEinheiten</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static DeaEinheiten merge(DeaEinheiten detachedInstance) {
        log.debug("Merging DeaEinheiten instance " + detachedInstance);
    ...
    public boolean merge() {
        return DeaEinheiten.merge(this).equals(this);
    }
    ...
    public static boolean delete(DeaEinheiten detachedInstance) {
        log.debug("Deleting DeaEinheiten instance " + detachedInstance);
    ...
    public boolean delete() {
        return DeaEinheiten.delete(this);
    }

    /**
     * Find an <code>DeaEinheiten</code> instance by its primary key
     * @param id the primary key value
     * @return <code>DeaEinheiten</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static DeaEinheiten findById(de.bielefeld.umweltamt.aui.mappings.generated.tipi.DeaEinheitenId id) {
    ...
    /**
     * Get a list of all <code>DeaEinheiten</code>
     * @return <code>List&lt;DeaEinheiten&gt;</code>
     *         all <code>DeaEinheiten</code>
     */
    public static List<DeaEinheiten> getAll() {
        log.debug("Getting all DeaEinheiten instances");
        String query = "FROM DeaEinheiten";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<DeaEinheiten> resultList = new ArrayList<DeaEinheiten>();
        DeaEinheiten result = null;
        for (Object object : objectList) {
            result = (DeaEinheiten) object;
