 ...
 * {@link DeaAnhang}.
 */
public abstract class AbstractDeaAnhang  implements java.io.Serializable {

     private DeaAnhangId id;
    ...
    public AbstractDeaAnhang() {
    }

    public AbstractDeaAnhang(
    	DeaAnhangId id, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, String anhRegelwerk, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
    ...
    public AbstractDeaAnhang(
    	DeaAnhangId id, Date inkaGueltigVon, Date inkaGueltigBis, short istAktuellTog, Date erfassungsDatum, Date aenderungsDatum, String anhRegelwerk, String anhText, int zustandsNr, Date gueltigVon, Date igStichtag, Date gueltigBis, Date erstellDat, Date aktualDat, int versionsnr, Date zeitstempel) {
        this.id = id;
        this.inkaGueltigVon = inkaGueltigVon;
    ...
    public DeaAnhangId getId() {
        return this.id;
    }
    public void setId(DeaAnhangId id) {
        this.id = id;
    }
