...
public abstract class AbstractDeaTk25  implements java.io.Serializable {
    ...
    public AbstractDeaTk25(
    	DeaTk25Id id, Date inkaGueltigVon, short istAktuellTog, Date erfassungsDatum, int zustandsNr, Date gueltigVon, Date erstellDat, Date aktualDat, int versionsnr) {
        this.id = id;
