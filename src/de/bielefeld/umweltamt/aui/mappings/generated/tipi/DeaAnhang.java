...
/**
 * A class that represents a row in the DeaAnhang database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class DeaAnhang  implements java.io.Serializable {
    ...
    /** Minimal constructor */
    public DeaAnhang(
        DeaAnhangId id, Calendar inkaGueltigVon, short istAktuellTog, Calendar erfassungsDatum, String anhRegelwerk, int zustandsNr, Calendar gueltigVon, Calendar erstellDat, Calendar aktualDat, int versionsnr) {
        this.id = id;
    ...
    /** Full constructor */
    public DeaAnhang(
        DeaAnhangId id, Calendar inkaGueltigVon, Calendar inkaGueltigBis, short istAktuellTog, Calendar erfassungsDatum, Calendar aenderungsDatum, String anhRegelwerk, String anhText, int zustandsNr, Calendar gueltigVon, Calendar igStichtag, Calendar gueltigBis, Calendar erstellDat, Calendar aktualDat, int versionsnr, Calendar zeitstempel) {
        this.id = id;
        this.inkaGueltigVon = inkaGueltigVon;
     ...
     * @return <code>DeaAnhang</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static DeaAnhang merge(DeaAnhang detachedInstance) {
        log.debug("Merging DeaAnhang instance " + detachedInstance);
    ...
    public boolean merge() {
        return DeaAnhang.merge(this).equals(this);
    }
    ...
    public static boolean delete(DeaAnhang detachedInstance) {
        log.debug("Deleting DeaAnhang instance " + detachedInstance);
    ...
    public boolean delete() {
        return DeaAnhang.delete(this);
    }

    /**
     * Find an <code>DeaAnhang</code> instance by its primary key
     * @param id the primary key value
     * @return <code>DeaAnhang</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static DeaAnhang findById(de.bielefeld.umweltamt.aui.mappings.generated.tipi.DeaAnhangId id) {
    ...
    /**
     * Get a list of all <code>DeaAnhang</code>
     * @return <code>List&lt;DeaAnhang&gt;</code>
     *         all <code>DeaAnhang</code>
     */
    public static List<DeaAnhang> getAll() {
        log.debug("Getting all DeaAnhang instances");
        String query = "FROM DeaAnhang";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<DeaAnhang> resultList = new ArrayList<DeaAnhang>();
        DeaAnhang result = null;
        for (Object object : objectList) {
            result = (DeaAnhang) object;
