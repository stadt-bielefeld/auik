...
public class VawsAbscheider  implements java.io.Serializable {
    ...
    public boolean merge() {
        return VawsAbscheider.merge(this).equals(this);
    }
     ...
     *         <code>null</code> otherwise
     */
    public static VawsAbscheider findById(int id) {
    ...
    public static List<VawsAbscheider> getAll() {
        log.debug("Getting all VawsAbscheider instances");
        String query = "FROM VawsAbscheider";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<VawsAbscheider> resultList = new ArrayList<VawsAbscheider>();
        VawsAbscheider result = null;
        for (Object object : objectList) {
            result = (VawsAbscheider) object;
