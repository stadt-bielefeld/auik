...
public class VawsFachdaten extends AbstractVawsFachdaten {
    ...
    public static boolean saveOrUpdate(VawsFachdaten detachedInstance) {
    ...
    public VawsFachdaten findById( java.lang.Integer id) {
        log.debug("getting VawsFachdaten instance with id: " + id);
        VawsFachdaten instance = (VawsFachdaten)
