...
/**
 * VawsAbfuellflaeche generated by hbm2java
 */
public abstract class AbstractVawsAbfuellflaeche  implements java.io.Serializable {
    ...
    public AbstractVawsAbfuellflaeche(int behaelterid, boolean enabled, boolean deleted) {
        this.behaelterid = behaelterid;
        this.enabled = enabled;
        this.deleted = deleted;
    }
    public AbstractVawsAbfuellflaeche(int behaelterid, Boolean eoh, Boolean ef, Boolean abfsaniert, Boolean abfneuerstellt, String bodenflaechenausf, String beschbodenfl, Float dicke, String guete, String fugenmaterial, String beschfugenmat, String niederschlagschutz, Boolean abscheidervorh, String beschableitung, boolean enabled, boolean deleted) {
       this.behaelterid = behaelterid;
       this.eoh = eoh;
       this.ef = ef;
