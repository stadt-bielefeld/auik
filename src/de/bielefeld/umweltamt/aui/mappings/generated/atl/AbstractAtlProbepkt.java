...
/**
 * AtlProbepkt generated by hbm2java
 */
public abstract class AbstractAtlProbepkt  implements java.io.Serializable {
    ...
    public AbstractAtlProbepkt(BasisObjekt basisObjekt, boolean enabled, boolean deleted) {
        this.basisObjekt = basisObjekt;
        this.enabled = enabled;
        this.deleted = deleted;
    }
    public AbstractAtlProbepkt(AtlProbeart atlProbeart, AtlKlaeranlagen atlKlaeranlagen, BasisObjekt basisObjekt, BasisSachbearbeiter basisSachbearbeiter, AtlSielhaut atlSielhaut, String beschreibung, Integer nrProbepkt, Integer firmenId, String branche, boolean enabled, boolean deleted, Set<AtlProbenahmen> atlProbenahmens) {
