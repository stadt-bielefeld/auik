...
public class AtlStatus  implements java.io.Serializable {
    ...
    /** Full constructor */
    public AtlStatus(
        int id, String bezeichnung, boolean enabled, boolean deleted, Set<AtlProbenahmen> atlProbenahmens) {
        this.id = id;
    ...
    public static List<AtlStatus> getAll() {
        log.debug("Getting all AtlStatus instances");
        String query = "FROM AtlStatus";
        List<?> objectList = new DatabaseAccess().createQuery(query).list(); 
        List<AtlStatus> resultList = new ArrayList<AtlStatus>();
        AtlStatus result = null;
        for (Object object : objectList) {
            result = (AtlStatus) object;
