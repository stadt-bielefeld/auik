...
public class Adresse implements java.io.Serializable {
	...
	private static final long serialVersionUID = DatabaseSerialVersionUID.forAdresse;
	...
	/** Minimal constructor */
	public Adresse(Integer id, boolean enabled, boolean deleted) {
		this.id = id;
	...
	/** Full constructor */
	public Adresse(Integer id, Standortgghwsg standortgghwsg, Wassereinzugsgebiet wassereinzugsgebiet,
			Gemarkung gemarkung, String strasse, Integer hausnr, String hausnrzus, String plzzs, String plz, String ort,
			String flur, String flurstueck, String entgebid, String strasseeigent, String sachbe33rav,
			String sachbe33hee, Boolean ueberschgeb, String bemerkungen, Date revidatum, String revihandz,
			boolean enabled, boolean deleted, Date erstellDat, Integer iglId, Set<Inhaber> inhabers) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Adresse))
			return false;
		return (this.getId().equals(((Adresse) other).getId()));
	}
	...
	public static Adresse findById(java.lang.Integer id) {
		...
		return (Adresse) new DatabaseAccess().get(Adresse.class, id);
	}
