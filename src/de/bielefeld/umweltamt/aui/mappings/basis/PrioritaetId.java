...
/**
 * A class that represents a row in the PrioritaetId database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class PrioritaetId  implements java.io.Serializable {
    ...
    /** Full constructor */
    public PrioritaetId(
        Integer standortId, Integer betreiberId) {
