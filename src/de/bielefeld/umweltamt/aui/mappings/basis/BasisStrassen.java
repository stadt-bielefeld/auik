    ...
    implements Serializable
{
	...
	// Nur nˆtig, weil wir Strassen so komisch handhaben...
    /**
...
//			HibernateSessionFactory.closeSession();
	...
	/**
	 * Liefert alle vorhandenen Straﬂennamen als Strings.
	 * @param session Eine Hibernate-Session
	 * @return Alle vorhandenen Straﬂennamen
	...
	/**
	 * Liefert alle vorhandenen Straﬂennamen als Strings. 
	 * Erzeugt f¸r die Abfrage eine neue Hibernate-Session und
	 * schlieﬂt sie dann wieder. Diese Methode nur an Stellen benutzen,
	 * wo gerade keine offene Session zur Verf¸gung steht.
	 * @return Alle vorhandenen Straﬂennamen
	 * @throws HibernateException Wenn ein Datenbank-Fehler auftritt
	 */
