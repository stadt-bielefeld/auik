...
/**
 * A class that represents a row in the Fachdaten database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class Fachdaten  implements java.io.Serializable {
    ...
    private Set<Anlagenchrono> anlagenchronos = new HashSet<Anlagenchrono>(0);
    ...
    /** Minimal constructor */
    public Fachdaten(
        Objekt objekt, boolean enabled, boolean deleted) {
        this.objekt = objekt;
    ...
    public Fachdaten(
        ...
        this.anlagenchronos = anlagenchronos;
    ...
    public Set<Anlagenchrono> getAnlagenchronos() {
        return this.anlagenchronos;
    }

    public void setAnlagenchronos(Set<Anlagenchrono> anlagenchronos) {
        this.anlagenchronos = anlagenchronos;
    }
    ...
    public Set<Jgs> getJgses() {
        return this.jgses;
    }

    public void setJgses(Set<Jgs> jgses) {
        this.jgses = jgses;
    }

    public Set<Kontrollen> getKontrollens() {
        return this.kontrollens;
    }

    public void setKontrollens(Set<Kontrollen> kontrollens) {
        this.kontrollens = kontrollens;
    }

    public Set<Abscheider> getAbscheiders() {
        return this.abscheiders;
    }

    public void setAbscheiders(Set<Abscheider> abscheiders) {
        this.abscheiders = abscheiders;
    }
    ...
    public Set<Verwaltungsverf> getVerwaltungsverfs() {
        return this.verwaltungsverfs;
    }

    public void setVerwaltungsverfs(Set<Verwaltungsverf> verwaltungsverfs) {
        this.verwaltungsverfs = verwaltungsverfs;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Fachdaten)) return false;
        return (this.getBehaelterid().equals(
            ((Fachdaten) other).getBehaelterid()));
    }
     ...
     * @return <code>Fachdaten</code> the merged instance,
     *         if everything went okay,
     *         <code>null</code> otherwise
     */
    public static Fachdaten merge(Fachdaten detachedInstance) {
        log.debug("Merging Fachdaten instance " + detachedInstance);
        return (Fachdaten) new DatabaseAccess().merge(detachedInstance);
    }
    ...
    public boolean merge() {
        Fachdaten saved = Fachdaten.merge(this);
        if (saved == null) {
            return false;
        } else {
            this.copy(saved);
    ...
    /**
     * Update this Fachdaten with its new values.<br>
     ...
     *         <code>false</code> otherwise
     */
    public static boolean delete(Fachdaten detachedInstance) {
        log.debug("Deleting Fachdaten instance " + detachedInstance);
    ...
    public boolean delete() {
        return Fachdaten.delete(this);
    }

    /**
     * Find an <code>Fachdaten</code> instance by its primary key
     * @param id the primary key value
     * @return <code>Fachdaten</code> the requested instance,
     *         if one exists,
     *         <code>null</code> otherwise
     */
    public static Fachdaten findById(java.lang.Integer id) {
        log.debug("Getting Fachdaten instance with id: " + id);
        return (Fachdaten)
            new DatabaseAccess().get(Fachdaten.class, id);
    }

    /**
     * Get a list of all <code>Fachdaten</code>
     * @return <code>List&lt;Fachdaten&gt;</code>
     *         all <code>Fachdaten</code>
     */
    public static List<Fachdaten> getAll() {
        return DatabaseQuery.getAll(new Fachdaten());
    }
