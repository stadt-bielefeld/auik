...
/**
 * A class that represents a row in the ZElsWasserrechtId database table.<br>
 * This class is meant to serve as a model and should be copied into the
 * appropriate package and may be customized below the given mark.
 */
public class EZElsWasserrechtId  implements java.io.Serializable {
    ...
    public long getElsNr() {
        return this.elsNr;
    }

    public void setElsNr(long elsNr) {
        this.elsNr = elsNr;
    }
