//$Id: HibernateSessionObjectFactory.java,v 1.1 2008-06-05 11:38:40 u633d Exp $
...
import org.apache.commons.logging.LogFactory;
  ...
  */
 public class HibernateSessionObjectFactory implements ObjectFactory {
 
     private static final HibernateSessionObjectFactory INSTANCE; //to stop the class from being unloaded
 
     private static final Log log;
 
     static {
         log = LogFactory.getLog(HibernateSessionObjectFactory.class);
         INSTANCE = new HibernateSessionObjectFactory();
